            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                    ...
                    <div className="flex justify-between items-center">
                            <a href="https://github.com/Ansh0305/CampGround" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View code →</a>
                            <a href="https://indicamp.onrender.com/" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View project →</a>
                    </div>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                    ...
                    <div className="flex justify-between items-center">
                            <a href="https://github.com/Ansh0305/MovieHub" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View code →</a>
                            <a href="https://moviehuby.netlify.app/" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View project →</a>
                    </div>
                </div>
                ...
                <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 246, 0.1)] transition-all">
                    ...
                    <div className="flex justify-between items-center">
                            <a href="https://github.com/Ansh0305/Projects/tree/main/Spotify" target="_blank" className="text-blue-400 hover:text-blue-300 transition-colors my-4">View Code →</a>
                    </div>
                </div>
